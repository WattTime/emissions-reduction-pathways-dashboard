...
LEFT JOIN ( 
        ...
        from strategy_categorical_scores cs
...
at the subsector-asset output level, weighted by activity. The subsector stats
will be calculated only with most-granular data
'''
subsector_stats AS (
        SELECT
                subsector
