...
def demo_create_assets_filter_sql(annual_asset_path, selected_subsector, selected_year):
...
def demo_query_country_sector(annual_asset_path, gadm_0_path, gadm_1_path, gadm_2_path, selected_subsector, selected_year):
    formatted_subsectors = ', '.join(f"'{subsector}'" for subsector in selected_subsector)
    query_sector_assets_sql = f'''
        SELECT 
            ae.year,
...
def demo_query_top_1000_assets(annual_asset_path, gadm_0_path, gadm_1_path, gadm_2_path, selected_subsector, selected_year):
    formatted_subsectors = ', '.join(f"'{subsector}'" for subsector in selected_subsector)
...
def demo_summarize_ers_sql(annual_asset_path, selected_subsector, selected_year):
    formatted_subsectors = ', '.join(f"'{subsector}'" for subsector in selected_subsector)
    query_ers_sql = f'''
        with de_dupe as (
			select distinct asset_id
...
def demo_create_table_assets_sql(annual_asset_path, gadm_0_path, gadm_1_path, gadm_2_path, selected_subsector, selected_year):
    formatted_subsectors = ', '.join(f"'{subsector}'" for subsector in selected_subsector)
    query_table_assets_sql = f'''
        SELECT 
            ae.subsector,
