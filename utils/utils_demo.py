...
def plot_abatement_curve(gdf_asset, selected_group, selected_color, dict_color, dict_lines, selected_assets, selected_x, selected_y, threshold, fill=False, cond={}):
